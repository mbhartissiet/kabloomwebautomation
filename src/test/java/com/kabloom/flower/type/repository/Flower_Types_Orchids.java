...
public class Flower_Types_Orchids {
	
	public static Logger log = Logger.getLogger(Flower_Types_Orchids.class);
	
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[3]/span")
	 private WebElement flower_types;
	  
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[3]/ul/li[3]/a/span")
	 private WebElement orchids;
	 
	 @FindAll({@FindBy(xpath = "//*[@class='product-image']")})
	 public List<WebElement> product_image;
	 
	 public Flower_Types_Orchids clickOnFlowertype(){
		 flower_types.click(); 
		 Flower_Types_Orchids flower_types_orchids = new Flower_Types_Orchids(Driver.driver);
		 return flower_types_orchids;
	 }
	 public void clickOnOrchids(){
	
		 Actions actions = new Actions(Driver.driver);
		 actions.moveToElement(flower_types).moveToElement(orchids).click().build().perform();
	 }
	 ...
	 public Flower_Types_Orchids(WebDriver driver){
