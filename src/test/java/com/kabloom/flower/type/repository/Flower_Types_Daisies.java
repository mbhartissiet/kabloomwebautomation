...
public class Flower_Types_Daisies {
	
	 public static Logger log = Logger.getLogger(Flower_Types_Daisies.class);
	 
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[3]/span")
	 private WebElement flower_types;
	  
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[3]/ul/li[5]/a/span")
	 private WebElement daisies ;
	 
	 @FindAll({@FindBy(xpath = "//*[@class='product-image']")})
	 public List<WebElement> product_image;
	 
	  
	 public Flower_Types_Daisies clickOnFlowertype(){
		 flower_types.click(); 
		 Flower_Types_Daisies flower_types_daisies = new Flower_Types_Daisies(Driver.driver);
		 return flower_types_daisies;
	 }
	 public void clickOnDaisies(){
			
			 Actions actions = new Actions(Driver.driver);
			 actions.moveToElement(flower_types).moveToElement(daisies).click().build().perform();
		 }
	 public Flower_Types_Daisies(WebDriver driver){
