...
import testBase.Driver;
     public class Annivarsary_Page {
	
     public static Logger log = Logger.getLogger(Annivarsary_Page.class);
	 ...
	 public void clickOnAnniversary(){
		 ...
		 actions.moveToElement(occasions).moveToElement(anniversary).click().build().perform();
	 }
	 ...
	 public Annivarsary_Page(WebDriver driver){
