...
public class Congratulations_Page {
	
     public static Logger log = Logger.getLogger(Congratulations_Page.class);
    
     @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/span")
	 private WebElement occasions;
	  
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/ul/li[3]/a/span")
	 ...
	 public Congratulations_Page clickOnOccasions(){
		 occasions.click(); 
		 Congratulations_Page congratulations_page = new Congratulations_Page(Driver.driver);
		 return congratulations_page;
	 }
	 public void clickOnCongratulations(){
		
		 Actions actions = new Actions(Driver.driver);
		 actions.moveToElement(occasions).moveToElement(congratulations).click().build().perform();
	 }
	 public Add_To_Cart_Page selectFlower() throws InterruptedException
		{   
		    clickOnCongratulations();
		    Thread.sleep(3000);
			try
			{
	  ...
	  public Congratulations_Page(WebDriver driver){
