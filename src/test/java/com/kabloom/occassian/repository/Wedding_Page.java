...
import testBase.Driver;
    ...
    public class Wedding_Page {
    public static Logger log = Logger.getLogger(Wedding_Page.class);
	 
     @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/span")
	 private WebElement occasions;
	  
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/ul/li[12]/a/span")
	 ...
	 public Wedding_Page clickOnOccasions(){
		 occasions.click(); 
		 Wedding_Page wedding_page = new Wedding_Page(Driver.driver);
		 return wedding_page;
	 }
	 public void clickOnWedding(){
		
		 Actions actions = new Actions(Driver.driver);
		 actions.moveToElement(occasions).moveToElement(wedding).click().build().perform();
	 }
	 ...
	 public Wedding_Page(WebDriver driver){
