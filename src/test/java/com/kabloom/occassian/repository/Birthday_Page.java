...
import testBase.Driver;
   ...
   public class Birthday_Page {
	
	 //public Actions actions;
     public static Logger log = Logger.getLogger(Birthday_Page.class);
	 ...
	 public Birthday_Page clickOnOccasions(){
		 occasions.click(); 
		 Birthday_Page birthday_page = new Birthday_Page(Driver.driver);
		 return birthday_page;
	 }
	 public void clickOnbirthday(){
		
		 Actions actions = new Actions(Driver.driver);
		 actions.moveToElement(occasions).moveToElement(birthday).click().build().perform();
	 }
	 ...
	 public Birthday_Page(WebDriver driver){
