...
import testBase.Driver;
    ...
    public class Sympathy_Page {
	
	
     public static Logger log = Logger.getLogger(Sympathy_Page.class);
     
     @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/span")
	 private WebElement occasions;
	  
	 @FindBy(how=How.XPATH,using="//*[@id='nav']/li[4]/ul/li[10]/a/span")
	 private WebElement sympathy;
	 
	 @FindAll({@FindBy(xpath = "//*[@class='product-image']")})
	 public List<WebElement> product_image;
	 
	 
	 public Sympathy_Page clickOnOccasions(){
		 occasions.click(); 
		 Sympathy_Page sympathy_page = new Sympathy_Page(Driver.driver);
		 return sympathy_page;
	 }
	 public void clickOnAnniversary(){
		
		 Actions actions = new Actions(Driver.driver);
		 actions.moveToElement(occasions).moveToElement(sympathy).click().build().perform();
	 }
	 public Add_To_Cart_Page selectFlower() throws InterruptedException
	  ...
	  public Sympathy_Page(WebDriver driver){
